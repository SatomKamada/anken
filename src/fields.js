...
//   分類「商品規格情報」    → ＋ボタンで増やす明細（1:多）（specFields）
//
...
export const specFields = [
  ...
  { key: 'newSpecFlag',    label: '規格新規作成フラグ',      type: 'checkbox' },
  { key: 'newSpecCatFlag', label: '規格分類新規作成フラグ',   type: 'checkbox' },
  { key: 'specName1',      label: '規格名1',              type: 'text' },
  { key: 'specCatName1',   label: '規格分類名1',           type: 'text',   note: '例）チョコ' },
  { key: 'specCatName2',   label: '規格分類名2',           type: 'text',   note: '例）S（最大2つまで）' },
  ...
  {
    key: 'lotteryScope', label: '抽選対象範囲区分', type: 'select',
    options: ['会員','非会員','会員/非会員'],
  },
  ...
  {
    key: 'targetChannel', label: '対象チャネル', type: 'checkboxGroup',
    options: ['web','アプリ','実店舗'],
  },
  {
